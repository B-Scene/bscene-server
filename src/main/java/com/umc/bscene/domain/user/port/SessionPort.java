...
public interface SessionPort {
    ...
    Long decideApplicationSubmission(Long sasId, Long deciderUserId, boolean isApproved);
    ...
    Long finalizeApplicationSubmission(Long sasId, Long applicantUserId, boolean isAccepted);
