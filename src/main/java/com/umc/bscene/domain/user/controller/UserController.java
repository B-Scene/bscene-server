...
public class UserController {
    ...
    @PutMapping("/me/mode")
    public ResponseEntity<SuccessResponse<?>> toggleUserMode(
            @AuthenticationPrincipal AuthMember authMember
    ) {
        userService.toggleUpdateMode(authMember.getUser());
    ...
    public ResponseEntity<SuccessResponse<?>> patchUserMode(
            @AuthenticationPrincipal AuthMember authMember,
